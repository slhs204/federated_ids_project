"""
Flower Federated Learning Server Implementation (Version Compatible)

Supports FedAvg, FedProx strategies with evaluation
Compatible with Flower 1.8.0+
"""
...
def get_evaluate_fn(model, test_loader, device="cuda"):
    ...
    def evaluate(
        ...
        # parameters is a list of numpy arrays
...
def create_strategy(
    ...
    """
    Create FL strategy with version compatibility
    ...
    # Flower 1.8+ uses 'on_fit_config_fn'
    # Older versions use 'on_fit_config'
    try:
        # Try new parameter name first (Flower 1.8+)
        common_args = {
            ...
            "on_fit_config_fn": on_fit_config_fn,  # New name
        ...
        # If new parameter name doesn't work, try old name
        if "on_fit_config_fn" in str(e) or "on_fit_config" in str(e):
            print("⚠️  Using compatibility mode for older Flower version")
            common_args = {
                "fraction_fit": fraction_fit,
                "fraction_evaluate": fraction_evaluate,
                "min_fit_clients": min_fit_clients,
                ...
                "initial_parameters": initial_parameters,
                "evaluate_fn": evaluate_fn,
                "on_fit_config": on_fit_config_fn,  # Old name
                "evaluate_metrics_aggregation_fn": weighted_average,
            }
...
if __name__ == "__main__":
    ...
    print("To start actual training, run train_federated_quick.py")
    print("=" * 60)