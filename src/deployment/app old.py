...
class InferenceEngine:
    ...
    def __init__(self, model_path: str = None, device: str = "cuda"):
        ...
        self.feature_mean = np.zeros(78)
        self.feature_std = np.ones(78)
...
def predict_from_csv(csv_file):
    ...
    try:
        ...
        # Take first row (or you can process multiple rows)
        features = df.iloc[0].values[:78]  # Take first 78 features
